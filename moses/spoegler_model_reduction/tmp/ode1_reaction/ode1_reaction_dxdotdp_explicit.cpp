...
#include "ode1_reaction_dxdotdp_explicit.h"

namespace amici {
namespace model_ode1_reaction {

void dxdotdp_explicit_ode1_reaction(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w){
