...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "ode1_reaction.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'ode1_reaction._ode1_reaction',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'ode1_reaction',
...
setup(
    ...
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model ode1_reaction',
