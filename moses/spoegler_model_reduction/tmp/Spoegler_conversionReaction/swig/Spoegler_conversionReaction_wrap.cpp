...
/*-----------------------------------------------
              @(target):= _Spoegler_conversionReaction.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__Spoegler_conversionReaction

#else
#  define SWIG_init    init_Spoegler_conversionReaction

#endif
#define SWIG_name    "_Spoegler_conversionReaction"
