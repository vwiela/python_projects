...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "Spoegler_conversionReaction.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'Spoegler_conversionReaction._Spoegler_conversionReaction',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'Spoegler_conversionReaction',
...
# Install
setup(
    name='Spoegler_conversionReaction',
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model Spoegler_conversionReaction',
    ...
    install_requires=['amici==0.11.25'],
