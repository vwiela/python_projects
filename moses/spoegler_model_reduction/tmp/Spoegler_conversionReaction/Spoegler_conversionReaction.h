...
extern void Jy_Spoegler_conversionReaction(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydsigma_Spoegler_conversionReaction(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_Spoegler_conversionReaction(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_Spoegler_conversionReaction(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_Spoegler_conversionReaction(SUNMatrixWrapper &rowvals, int index);
...
extern void dxdotdp_explicit_Spoegler_conversionReaction(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdp_explicit_colptrs_Spoegler_conversionReaction(SUNMatrixWrapper &colptrs);
extern void dxdotdp_explicit_rowvals_Spoegler_conversionReaction(SUNMatrixWrapper &rowvals);
extern void dxdotdx_explicit_Spoegler_conversionReaction(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdx_explicit_colptrs_Spoegler_conversionReaction(SUNMatrixWrapper &colptrs);
extern void dxdotdx_explicit_rowvals_Spoegler_conversionReaction(SUNMatrixWrapper &rowvals);
extern void dydx_Spoegler_conversionReaction(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);

extern void sigmay_Spoegler_conversionReaction(realtype *sigmay, const realtype t, const realtype *p, const realtype *k);
...
extern void xdot_Spoegler_conversionReaction(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void y_Spoegler_conversionReaction(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);




extern void x_solver_Spoegler_conversionReaction(realtype *x_solver, const realtype *x_rdata);


/**
 * @brief AMICI-generated model subclass.
 */
class Model_Spoegler_conversionReaction : public amici::Model_ODE {
  public:
    /**
     * @brief Default constructor.
     */
    Model_Spoegler_conversionReaction()
        : amici::Model_ODE(
    ...
    amici::Model *clone() const override {
        return new Model_Spoegler_conversionReaction(*this);
    }
    ...
    void fJy(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        Jy_Spoegler_conversionReaction(Jy, iy, p, k, y, sigmay, my);
    }
    ...
    void fdJydsigma(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydsigma_Spoegler_conversionReaction(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    void fdJydy(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydy_Spoegler_conversionReaction(dJydy, iy, p, k, y, sigmay, my);
    }

    void fdJydy_colptrs(SUNMatrixWrapper &colptrs, int index) override {        dJydy_colptrs_Spoegler_conversionReaction(colptrs, index);
    }

    void fdJydy_rowvals(SUNMatrixWrapper &rowvals, int index) override {        dJydy_rowvals_Spoegler_conversionReaction(rowvals, index);
    }
    ...
    void fdxdotdp_explicit(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdp_explicit_Spoegler_conversionReaction(dxdotdp_explicit, t, x, p, k, h, w);
    }

    void fdxdotdp_explicit_colptrs(SUNMatrixWrapper &colptrs) override {        dxdotdp_explicit_colptrs_Spoegler_conversionReaction(colptrs);
    }

    void fdxdotdp_explicit_rowvals(SUNMatrixWrapper &rowvals) override {        dxdotdp_explicit_rowvals_Spoegler_conversionReaction(rowvals);
    }
    ...
    void fdxdotdx_explicit(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdx_explicit_Spoegler_conversionReaction(dxdotdx_explicit, t, x, p, k, h, w);
    }

    void fdxdotdx_explicit_colptrs(SUNMatrixWrapper &colptrs) override {        dxdotdx_explicit_colptrs_Spoegler_conversionReaction(colptrs);
    }

    void fdxdotdx_explicit_rowvals(SUNMatrixWrapper &rowvals) override {        dxdotdx_explicit_rowvals_Spoegler_conversionReaction(rowvals);
    }
    ...
    void fdydx(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        dydx_Spoegler_conversionReaction(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    void fsigmay(realtype *sigmay, const realtype t, const realtype *p, const realtype *k) override {
        sigmay_Spoegler_conversionReaction(sigmay, t, p, k);
    }
    ...
    void fxdot(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        xdot_Spoegler_conversionReaction(xdot, t, x, p, k, h, w);
    }
    ...
    void fy(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        y_Spoegler_conversionReaction(y, t, x, p, k, h, w);
    }
    ...
    void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_Spoegler_conversionReaction(x_solver, x_rdata);
    }
    ...
    std::string getName() const override {
        return "Spoegler_conversionReaction";
    }
