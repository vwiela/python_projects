"""AMICI-generated module for model test_reaction"""

import amici

# Ensure we are binary-compatible, see #556
if '0.11.25' != amici.__version__:
    raise RuntimeError('Cannot use model test_reaction, generated with AMICI '
...
from test_reaction._test_reaction import *
