...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "test_reaction.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'test_reaction._test_reaction',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'test_reaction',
...
setup(
    ...
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model test_reaction',
