...
extern void Jy_test_reaction(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydsigma_test_reaction(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_test_reaction(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_test_reaction(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_test_reaction(SUNMatrixWrapper &rowvals, int index);

extern void dwdp_test_reaction(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp);
extern void dwdp_colptrs_test_reaction(SUNMatrixWrapper &colptrs);
extern void dwdp_rowvals_test_reaction(SUNMatrixWrapper &rowvals);
extern void dwdx_test_reaction(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_test_reaction(SUNMatrixWrapper &colptrs);
extern void dwdx_rowvals_test_reaction(SUNMatrixWrapper &rowvals);



extern void dxdotdw_test_reaction(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_test_reaction(SUNMatrixWrapper &colptrs);
extern void dxdotdw_rowvals_test_reaction(SUNMatrixWrapper &rowvals);
...
extern void dydx_test_reaction(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);

extern void sigmay_test_reaction(realtype *sigmay, const realtype t, const realtype *p, const realtype *k);

extern void w_test_reaction(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);




extern void xdot_test_reaction(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void y_test_reaction(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);




extern void x_solver_test_reaction(realtype *x_solver, const realtype *x_rdata);


/**
 * @brief AMICI-generated model subclass.
 */
class Model_test_reaction : public amici::Model_ODE {
  public:
    /**
    ...
    Model_test_reaction()
        : amici::Model_ODE(
              ...
              amici::SimulationParameters(
                  ...
                  std::vector<realtype>{0.10000000000000001, 0.10000000000000001, 1.0}        // dynamic parameters
              ),
    ...
    amici::Model *clone() const override {
        return new Model_test_reaction(*this);
    }
    ...
    void fJy(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        Jy_test_reaction(Jy, iy, p, k, y, sigmay, my);
    }
    ...
    void fdJydsigma(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydsigma_test_reaction(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    void fdJydy(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydy_test_reaction(dJydy, iy, p, k, y, sigmay, my);
    }

    void fdJydy_colptrs(SUNMatrixWrapper &colptrs, int index) override {        dJydy_colptrs_test_reaction(colptrs, index);
    }

    void fdJydy_rowvals(SUNMatrixWrapper &rowvals, int index) override {        dJydy_rowvals_test_reaction(rowvals, index);
    }
    ...
    void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp) override {
        dwdp_test_reaction(dwdp, t, x, p, k, h, w, tcl, dtcldp);
    }

    void fdwdp_colptrs(SUNMatrixWrapper &colptrs) override {        dwdp_colptrs_test_reaction(colptrs);
    }

    void fdwdp_rowvals(SUNMatrixWrapper &rowvals) override {        dwdp_rowvals_test_reaction(rowvals);
    }
    ...
    void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_test_reaction(dwdx, t, x, p, k, h, w, tcl);
    }

    void fdwdx_colptrs(SUNMatrixWrapper &colptrs) override {        dwdx_colptrs_test_reaction(colptrs);
    }

    void fdwdx_rowvals(SUNMatrixWrapper &rowvals) override {        dwdx_rowvals_test_reaction(rowvals);
    }
    ...
    void fdxdotdw(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdw_test_reaction(dxdotdw, t, x, p, k, h, w);
    }

    void fdxdotdw_colptrs(SUNMatrixWrapper &colptrs) override {        dxdotdw_colptrs_test_reaction(colptrs);
    }

    void fdxdotdw_rowvals(SUNMatrixWrapper &rowvals) override {        dxdotdw_rowvals_test_reaction(rowvals);
    }
    ...
    void fdydx(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        dydx_test_reaction(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    void fsigmay(realtype *sigmay, const realtype t, const realtype *p, const realtype *k) override {
        sigmay_test_reaction(sigmay, t, p, k);
    }
    ...
    void fw(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl) override {
        w_test_reaction(w, t, x, p, k, h, tcl);
    }
    ...
    void fxdot(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        xdot_test_reaction(xdot, t, x, p, k, h, w);
    }
    ...
    void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_test_reaction(x_solver, x_rdata);
    }
