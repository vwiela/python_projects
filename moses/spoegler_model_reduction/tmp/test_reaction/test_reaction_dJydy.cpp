...
#include "test_reaction_dJydy.h"

namespace amici {
namespace model_test_reaction {

void dJydy_test_reaction(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
