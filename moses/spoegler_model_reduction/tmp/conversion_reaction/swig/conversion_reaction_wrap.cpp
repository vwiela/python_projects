...
/*-----------------------------------------------
              @(target):= _conversion_reaction.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__conversion_reaction

#else
#  define SWIG_init    init_conversion_reaction

#endif
#define SWIG_name    "_conversion_reaction"
