...
#include "conversion_reaction_dxdotdx_explicit.h"

namespace amici {
namespace model_conversion_reaction {

void dxdotdx_explicit_conversion_reaction(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w){
