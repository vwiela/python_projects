...
/*-----------------------------------------------
              @(target):= _noisy_conversion_reaction.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__noisy_conversion_reaction

#else
#  define SWIG_init    init_noisy_conversion_reaction

#endif
#define SWIG_name    "_noisy_conversion_reaction"
