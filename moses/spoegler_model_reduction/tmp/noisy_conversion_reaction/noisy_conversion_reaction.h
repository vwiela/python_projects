...
extern void Jy_noisy_conversion_reaction(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydsigma_noisy_conversion_reaction(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_noisy_conversion_reaction(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_noisy_conversion_reaction(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_noisy_conversion_reaction(SUNMatrixWrapper &rowvals, int index);
...
extern void dxdotdp_explicit_noisy_conversion_reaction(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdp_explicit_colptrs_noisy_conversion_reaction(SUNMatrixWrapper &colptrs);
extern void dxdotdp_explicit_rowvals_noisy_conversion_reaction(SUNMatrixWrapper &rowvals);
extern void dxdotdx_explicit_noisy_conversion_reaction(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdx_explicit_colptrs_noisy_conversion_reaction(SUNMatrixWrapper &colptrs);
extern void dxdotdx_explicit_rowvals_noisy_conversion_reaction(SUNMatrixWrapper &rowvals);
extern void dydx_noisy_conversion_reaction(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void dydp_noisy_conversion_reaction(realtype *dydp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *dtcldp);
extern void sigmay_noisy_conversion_reaction(realtype *sigmay, const realtype t, const realtype *p, const realtype *k);
...
extern void xdot_noisy_conversion_reaction(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void y_noisy_conversion_reaction(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);




extern void x_solver_noisy_conversion_reaction(realtype *x_solver, const realtype *x_rdata);


/**
 * @brief AMICI-generated model subclass.
 */
class Model_noisy_conversion_reaction : public amici::Model_ODE {
  public:
    /**
     * @brief Default constructor.
     */
    Model_noisy_conversion_reaction()
        : amici::Model_ODE(
              ...
              amici::SimulationParameters(
                  ...
                  std::vector<realtype>{1.0, 0.10000000000000001, 0.10000000000000001}        // dynamic parameters
              ),
    ...
    amici::Model *clone() const override {
        return new Model_noisy_conversion_reaction(*this);
    }
    ...
    void fJy(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        Jy_noisy_conversion_reaction(Jy, iy, p, k, y, sigmay, my);
    }
    ...
    void fdJydsigma(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydsigma_noisy_conversion_reaction(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    void fdJydy(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydy_noisy_conversion_reaction(dJydy, iy, p, k, y, sigmay, my);
    }

    void fdJydy_colptrs(SUNMatrixWrapper &colptrs, int index) override {        dJydy_colptrs_noisy_conversion_reaction(colptrs, index);
    }

    void fdJydy_rowvals(SUNMatrixWrapper &rowvals, int index) override {        dJydy_rowvals_noisy_conversion_reaction(rowvals, index);
    }
    ...
    void fdxdotdp_explicit(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdp_explicit_noisy_conversion_reaction(dxdotdp_explicit, t, x, p, k, h, w);
    }

    void fdxdotdp_explicit_colptrs(SUNMatrixWrapper &colptrs) override {        dxdotdp_explicit_colptrs_noisy_conversion_reaction(colptrs);
    }

    void fdxdotdp_explicit_rowvals(SUNMatrixWrapper &rowvals) override {        dxdotdp_explicit_rowvals_noisy_conversion_reaction(rowvals);
    }
    ...
    void fdxdotdx_explicit(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdx_explicit_noisy_conversion_reaction(dxdotdx_explicit, t, x, p, k, h, w);
    }

    void fdxdotdx_explicit_colptrs(SUNMatrixWrapper &colptrs) override {        dxdotdx_explicit_colptrs_noisy_conversion_reaction(colptrs);
    }

    void fdxdotdx_explicit_rowvals(SUNMatrixWrapper &rowvals) override {        dxdotdx_explicit_rowvals_noisy_conversion_reaction(rowvals);
    }
    ...
    void fdydx(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        dydx_noisy_conversion_reaction(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    void fdydp(realtype *dydp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *dtcldp) override {
        dydp_noisy_conversion_reaction(dydp, t, x, p, k, h, ip, w, dtcldp);
    }
    ...
    void fsigmay(realtype *sigmay, const realtype t, const realtype *p, const realtype *k) override {
        sigmay_noisy_conversion_reaction(sigmay, t, p, k);
    }
    ...
    void fxdot(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        xdot_noisy_conversion_reaction(xdot, t, x, p, k, h, w);
    }
    ...
    void fy(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        y_noisy_conversion_reaction(y, t, x, p, k, h, w);
    }
    ...
    void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_noisy_conversion_reaction(x_solver, x_rdata);
    }
    ...
    std::string getName() const override {
        return "noisy_conversion_reaction";
    }
