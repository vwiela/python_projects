...
#include "noisy_conversion_reaction_dxdotdp_explicit.h"

namespace amici {
namespace model_noisy_conversion_reaction {

void dxdotdp_explicit_noisy_conversion_reaction(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w){
