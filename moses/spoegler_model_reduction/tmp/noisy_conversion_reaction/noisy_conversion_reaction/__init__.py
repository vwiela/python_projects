"""AMICI-generated module for model noisy_conversion_reaction"""

import amici

# Ensure we are binary-compatible, see #556
if '0.11.25' != amici.__version__:
    raise RuntimeError('Cannot use model noisy_conversion_reaction, generated with AMICI '
...
from noisy_conversion_reaction._noisy_conversion_reaction import *
