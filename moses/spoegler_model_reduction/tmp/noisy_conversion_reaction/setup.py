...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "noisy_conversion_reaction.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'noisy_conversion_reaction._noisy_conversion_reaction',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'noisy_conversion_reaction',
...
# Install
setup(
    name='noisy_conversion_reaction',
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model noisy_conversion_reaction',
