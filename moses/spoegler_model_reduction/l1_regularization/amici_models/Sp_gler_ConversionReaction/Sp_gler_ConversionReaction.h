...
extern void Jy_Sp_gler_ConversionReaction(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydsigma_Sp_gler_ConversionReaction(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_Sp_gler_ConversionReaction(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_Sp_gler_ConversionReaction(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_Sp_gler_ConversionReaction(SUNMatrixWrapper &rowvals, int index);
...
extern void dxdotdp_explicit_Sp_gler_ConversionReaction(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdp_explicit_colptrs_Sp_gler_ConversionReaction(SUNMatrixWrapper &colptrs);
extern void dxdotdp_explicit_rowvals_Sp_gler_ConversionReaction(SUNMatrixWrapper &rowvals);
extern void dxdotdx_explicit_Sp_gler_ConversionReaction(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdx_explicit_colptrs_Sp_gler_ConversionReaction(SUNMatrixWrapper &colptrs);
extern void dxdotdx_explicit_rowvals_Sp_gler_ConversionReaction(SUNMatrixWrapper &rowvals);
extern void dydx_Sp_gler_ConversionReaction(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);

extern void sigmay_Sp_gler_ConversionReaction(realtype *sigmay, const realtype t, const realtype *p, const realtype *k);
extern void dsigmaydp_Sp_gler_ConversionReaction(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const int ip);





extern void xdot_Sp_gler_ConversionReaction(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void y_Sp_gler_ConversionReaction(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);




extern void x_solver_Sp_gler_ConversionReaction(realtype *x_solver, const realtype *x_rdata);


/**
 * @brief AMICI-generated model subclass.
 */
class Model_Sp_gler_ConversionReaction : public amici::Model_ODE {
  public:
    /**
     * @brief Default constructor.
     */
    Model_Sp_gler_ConversionReaction()
        : amici::Model_ODE(
              ...
              amici::SimulationParameters(
                  ...
                  std::vector<realtype>{0.20000000000000001, 0.10000000000000001, 0.0, 0.0}        // dynamic parameters
              ),
    ...
    amici::Model *clone() const override {
        return new Model_Sp_gler_ConversionReaction(*this);
    }
    ...
    void fJy(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        Jy_Sp_gler_ConversionReaction(Jy, iy, p, k, y, sigmay, my);
    }
    ...
    void fdJydsigma(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydsigma_Sp_gler_ConversionReaction(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    void fdsigmaydp(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const int ip) override {
        dsigmaydp_Sp_gler_ConversionReaction(dsigmaydp, t, p, k, ip);
    }
    ...
    void fdJydy(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydy_Sp_gler_ConversionReaction(dJydy, iy, p, k, y, sigmay, my);
    }

    void fdJydy_colptrs(SUNMatrixWrapper &colptrs, int index) override {        dJydy_colptrs_Sp_gler_ConversionReaction(colptrs, index);
    }

    void fdJydy_rowvals(SUNMatrixWrapper &rowvals, int index) override {        dJydy_rowvals_Sp_gler_ConversionReaction(rowvals, index);
    }
    ...
    void fdxdotdp_explicit(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdp_explicit_Sp_gler_ConversionReaction(dxdotdp_explicit, t, x, p, k, h, w);
    }

    void fdxdotdp_explicit_colptrs(SUNMatrixWrapper &colptrs) override {        dxdotdp_explicit_colptrs_Sp_gler_ConversionReaction(colptrs);
    }

    void fdxdotdp_explicit_rowvals(SUNMatrixWrapper &rowvals) override {        dxdotdp_explicit_rowvals_Sp_gler_ConversionReaction(rowvals);
    }
    ...
    void fdxdotdx_explicit(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdx_explicit_Sp_gler_ConversionReaction(dxdotdx_explicit, t, x, p, k, h, w);
    }

    void fdxdotdx_explicit_colptrs(SUNMatrixWrapper &colptrs) override {        dxdotdx_explicit_colptrs_Sp_gler_ConversionReaction(colptrs);
    }

    void fdxdotdx_explicit_rowvals(SUNMatrixWrapper &rowvals) override {        dxdotdx_explicit_rowvals_Sp_gler_ConversionReaction(rowvals);
    }
    ...
    void fdydx(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        dydx_Sp_gler_ConversionReaction(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    void fsigmay(realtype *sigmay, const realtype t, const realtype *p, const realtype *k) override {
        sigmay_Sp_gler_ConversionReaction(sigmay, t, p, k);
    }
    ...
    void fxdot(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        xdot_Sp_gler_ConversionReaction(xdot, t, x, p, k, h, w);
    }
    ...
    void fy(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        y_Sp_gler_ConversionReaction(y, t, x, p, k, h, w);
    }
    ...
    void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_Sp_gler_ConversionReaction(x_solver, x_rdata);
    }
    ...
    std::string getName() const override {
        return "Sp_gler_ConversionReaction";
    }
