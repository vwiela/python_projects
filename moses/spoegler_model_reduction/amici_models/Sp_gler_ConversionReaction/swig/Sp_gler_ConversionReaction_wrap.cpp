...
/*-----------------------------------------------
              @(target):= _Sp_gler_ConversionReaction.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__Sp_gler_ConversionReaction

#else
#  define SWIG_init    init_Sp_gler_ConversionReaction

#endif
#define SWIG_name    "_Sp_gler_ConversionReaction"
