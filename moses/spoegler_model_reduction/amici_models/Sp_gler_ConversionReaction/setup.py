...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "Sp_gler_ConversionReaction.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'Sp_gler_ConversionReaction._Sp_gler_ConversionReaction',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'Sp_gler_ConversionReaction',
...
# Install
setup(
    name='Sp_gler_ConversionReaction',
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model Sp_gler_ConversionReaction',
